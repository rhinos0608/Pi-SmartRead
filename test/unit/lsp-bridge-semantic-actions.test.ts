      ...
      if (m) {
        ...
        try {
          ...
          if (msg.method === "initialize" && msg.id !== undefined) {
            queueMicrotask(() => sendToStdout(proc, { jsonrpc: "2.0", id: msg.id, result: { capabilities: { renameProvider: true, codeActionProvider: true, documentFormattingProvider: true } } }));
          }
        } catch {}
      }
      return true;
